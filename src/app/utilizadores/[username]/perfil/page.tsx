  ...
  const estatisticas = [
    {
      ...
      value: calcularAnosExperiencia(utilizador.contratacao)
    },
    {
      icon: <Briefcase className="h-5 w-5 text-blue-500" />,
      label: "Ocupação Média",
      value: `${(resumoOcupacao?.ocupacaoMediaAnual || 0).toFixed(0)}%`,
      trend: `${(resumoOcupacao?.ocupacaoMediaAnual || 0) > 70 ? 'Alta' : 'Normal'}`,
      trendUp: (resumoOcupacao?.ocupacaoMediaAnual || 0) > 70
    },
    {
