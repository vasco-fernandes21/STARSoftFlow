...
function ProjectListCard({
  ...
  return (
    <Card className="group flex h-full flex-col overflow-hidden border-slate-100 shadow-sm transition-all hover:shadow">
...
function FinancialSummaryCard({ summary }: { summary: typeof mockFinancialSummary }) {
  ...
  return (
    <Card className="flex h-full flex-col overflow-hidden border-slate-100 shadow-sm transition-all hover:shadow">
      <CardHeader className="flex flex-row items-center justify-between bg-white px-4 pb-3 pt-4">
        <div className="flex items-center gap-2">
