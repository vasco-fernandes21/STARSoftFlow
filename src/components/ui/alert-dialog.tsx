  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ref={ref}
        className={cn(
          "data-[state=open]:zoom-in-98 data-[state\\=closed]:slide-out-to-top-[48\\%] data-[state\\=open]:slide-in-from-top-[48\\%] fixed left-[50%] top-[50%] z-50 w-full max-w-md translate-x-[-50%] translate-y-[-50%] overflow-hidden rounded-2xl border bg-white/95 p-0 shadow-[0_10px_40px_-5px_rgba(0,0,0,0.15)] backdrop-blur-sm duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=open]:slide-in-from-left-1/2",
          borderColors[tipo],
          className
        )}
        {...props}
