...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-black/50 backdrop-blur-sm transition-all duration-200 data-&lsqb;state=open&rsqb;:animate-in data-&lsqb;state=closed&rsqb;:animate-out data-&lsqb;state=closed&rsqb;:fade-out-0 data-&lsqb;state=open&rsqb;:fade-in-0",
      className
    )}
    {...props}
    ref={ref}
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ref={ref}
        className={cn(
          "data-&lsqb;state=open&rsqb;:zoom-in-98 data-&lsqb;state=closed&rsqb;:slide-out-to-top-[48%] data-&lsqb;state=open&rsqb;:slide-in-from-top-[48%] fixed left-[50%] top-[50%] z-50 w-full max-w-md translate-x-[-50%] translate-y-[-50%] overflow-hidden rounded-2xl border bg-white/95 p-0 shadow-[0_10px_40px_-5px_rgba(0,0,0,0.15)] backdrop-blur-sm duration-200 data-&lsqb;state=open&rsqb;:animate-in data-&lsqb;state=closed&rsqb;:animate-out data-&lsqb;state=closed&rsqb;:fade-out-0 data-&lsqb;state=open&rsqb;:fade-in-0 data-&lsqb;state=closed&rsqb;:zoom-out-95 data-&lsqb;state=closed&rsqb;:slide-out-to-left-1/2 data-&lsqb;state=open&rsqb;:slide-in-from-left-1/2",
          borderColors[tipo],
          className
        )}
        {...props}
