...
import { UserCheck, Calendar, Percent, Users, BarChart2, User, Edit, Trash2, ChevronDown, ChevronUp } from "lucide-react";
...
export function Details({
  ...
  // Container unificado para ambos os modos (visualização e edição)
  return (
    <div className={`
      border border-azul/10 rounded-lg bg-white overflow-hidden
      ${isExpanded || isEditing ? 'shadow-md' : 'hover:shadow-sm'}
      transition-shadow
    `}>
      {isEditing ? (
        ...
        // Conteúdo do item em modo de visualização
        <>
          {/* Linha principal */}
          <div 
