    ...
    <div className="animate-fade-in space-y-8">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-1">
          <h1 className="text-2xl font-bold tracking-tight text-gray-900">Recursos Humanos</h1>
      ...
      {recursosProcessados.length > 0 ? (
          ...
          {recursosProcessados.map((recurso) => (
            <div key={recurso.id} className="group space-y-2">
              <Card
                ...
                onClick={() =>
                  setSelectedResource(selectedResource === recurso.id ? null : recurso.id)
                }
              >
              ...
              {selectedResource === recurso.id && (
                <div className="rounded-xl border border-slate-100 bg-slate-50/50 p-4 duration-200 animate-in slide-in-from-top-1">
                      ...
                      .map((wp) => (
                        ...
                        >
                          <div className="flex-1">
                            <p className="text-sm font-medium text-slate-900">{wp.nome}</p>
                          </div>
                          <Badge
                            variant="outline"
        ...
        <div className="flex min-h-[200px] items-center justify-center rounded-xl border border-dashed border-slate-200 bg-slate-50/50">
          <div className="text-center">
            ...
            <p className="mt-2 text-sm font-medium text-slate-600">Nenhum recurso alocado</p>
      ...
      <Card className="overflow-hidden">
        <div className="border-b border-slate-100 bg-slate-50/50 p-4">
          <h2 className="font-semibold text-slate-700">Distribuição de ETIs por Recurso</h2>
        </div>
        <div className="h-[300px] p-4">
          <ResponsiveContainer width="100%" height="100%">
            ...
            >
              ...
              <RechartsTooltip formatter={(value: number) => [formatEti(value), "ETI"]} />
              <Bar dataKey="mediaEtis" fill="#10b981" radius={[0, 4, 4, 0]} />
            </BarChart>
          </ResponsiveContainer>
        </div>
      </Card>
